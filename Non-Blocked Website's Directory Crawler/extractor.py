...
# -------------------------------------------
site_url = 'http://admissions.muet.edu.pk/download'  # Site URL where directory access is not blocked
site_url = site_url.strip('/')  # Remove Extra Seperators form each side
# -------------------------------------------
...
# ---------------------------------------------------
# TODO:
# 1.Scenario: link can lead to other site structure...
# 2.Downloading Bar should be displayed for increasing user experience.
# 3.Summary Report should be displayed at the end of the downloading.
# 4.Before starting downloading first display how many files are going to be downloaded and time expected.
# 5.Command line Colors introduced to further increase user experience.
# ---------------------------------------------------
# ---------------------------------------------------
